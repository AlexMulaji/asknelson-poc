    ...
    <MotionConfig reducedMotion="user">
      <div className="min-h-screen bg-canvas lg:flex lg:bg-white">
        ...
        <div className="flex w-full min-w-0 flex-col overflow-x-hidden">
          <main
            className="flex-1"
            // Use the CSS variable so padding dynamically includes the device
            // safe area — notched iPhones, Android gesture bars, etc. On desktop
            // the variable resolves to 0 (no bottom nav) via a media query.
