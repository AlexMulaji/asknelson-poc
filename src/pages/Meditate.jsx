  ...
  return (
    <div className="pt-6">
      ...
      <section className="mt-7">
        <h3 className="font-display text-[17px] font-extrabold text-navy lg:text-[19px]">
              ...
              >
                ...
                <span
                  className={[
                    ...
                    active ? 'font-extrabold text-navy' : 'font-bold text-slate-500',
                  ].join(' ')}
                >
                  {s.label}
                </span>
      ...
      <button
        type="button"
        onClick={begin}
        className="mt-10 grid min-h-[52px] w-full place-items-center rounded-btn bg-brand text-[15px] font-extrabold text-white transition hover:bg-brand-dark active:scale-[0.99] lg:max-w-[420px]"
      >
        Start Meditating
      </button>
